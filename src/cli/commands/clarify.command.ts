...
export function createClarifyCommand(dependencies: ClarifyCommandDependencies = {}): Command {
  ...
  command
    ...
    .action(
      async (questionId: string, targetPath: string | undefined, options: ClarifyAnswerOptions) => {
